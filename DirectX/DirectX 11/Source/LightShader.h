...
public:
	...
	[[nodiscard]] bool Render(struct ID3D11DeviceContext* context, UINT indexCount, class Texture* texture,
		DirectX::FXMMATRIX world, DirectX::CXMMATRIX view, DirectX::CXMMATRIX projection, const struct DirectionalLight& light);

	void Release() noexcept;

	bool SetParameter(ID3D11DeviceContext* context, Texture* texture, DirectX::FXMMATRIX worldMatrix,
