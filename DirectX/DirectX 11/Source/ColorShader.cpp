...
bool ColorShader::Initialize(ID3D11Device* device, HWND hWnd)
{
	...
	constexpr auto vsName = TEXT("ColorShader/ColorVertexShader.hlsl");
	constexpr auto psName = TEXT("ColorShader/ColorPixelShader.hlsl");
...
bool ColorShader::Render(ID3D11DeviceContext* context, UINT indexCount,
...
void ColorShader::Release() noexcept
{
	if (matrixBuffer)
	{
...
bool ColorShader::SetParameter(ID3D11DeviceContext* context,
...
void ColorShader::OutputShaderError(ID3D10Blob* errorMsg, HWND hWnd, LPCTSTR shader)
{
